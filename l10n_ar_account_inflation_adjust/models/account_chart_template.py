    ...
    def _create_bank_journals(self, company, acc_template_ref):
        ...
        journals_data = [
            ('Liquidación de IIBB', 'IIBB', 'allow_per_line', 'iibb_sufrido',
                ...
                ref('l10n_ar_account_inflation_adjust.tax_tag_a_cuenta_iibb'))
        ]
        ...
        if chart == ri_chart:
            journals_data += [
                ('Liquidación de IVA', 'IVA', 'yes', False,
                    ...
                    ref('l10n_ar_account_inflation_adjust.tax_tag_a_cuenta_iva'))]
        ...
        if chart in (ri_chart, ex_chart):
            journals_data += [
                ('Liquidación de Ganancias', 'GAN', 'yes', False,
                    ...
                    ref('l10n_ar_account_inflation_adjust.tax_tag_a_cuenta_ganancias')),
                ...
                ('Liquidación SICORE Aplicado', 'SICORE', 'allow_per_line',
                    ...
                    ref('l10n_ar_account_inflation_adjust.tag_ret_perc_sicore_aplicada')),
                ('Liquidación IIBB Aplicado', 'IB_AP', 'allow_per_line',
                    ...
                    ref('l10n_ar_account_inflation_adjust.tag_ret_perc_iibb_aplicada')),
            ]
