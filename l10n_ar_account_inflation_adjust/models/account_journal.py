...
class AccountJournal(models.Model):
    ...
    def sicore_aplicado_files_values(self, move_lines):
        ...
        for line in move_lines.sorted(key=lambda r: (r.date, r.id)):
            ...
            # Codigo de Regimen              [ 3]
            if line.tax_line_id.tax_group_id == self.env.ref('l10n_ar_account_inflation_adjust.tax_group_retencion_ganancias'):
                content += '0217'
            ...
            elif line.tax_line_id.tax_group_id == self.env.ref('l10n_ar_account_inflation_adjust.tax_group_retencion_iva'):
                content += '0767'
