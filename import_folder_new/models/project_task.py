...
class ProjectTaskInherit(models.Model):
    ...
    invoice_ids_filtered = fields.Many2many('account.move', 'task_id', string='Facturas proveedor (filtradas)')
    purchase_count = fields.Integer(compute='_compute_task_data_purchase', string="Cantidad OC")
    ...
    stock_count_i = fields.Integer(compute='_compute_task_data_stock', string="Cantidad Remitos")
