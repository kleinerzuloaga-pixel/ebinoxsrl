        ...
        * sino, devuelve el amount convertido a la moneda de la cia
        ...
        for rec in self:
            if not rec.other_currency:
                ...
                rec.force_amount_company_currency = rec.amount * rec.exchange_rate
                amount_company_currency = rec.force_amount_company_currency
                if rec.move_id and rec.move_id.state == 'draft':
                    rec.move_id.es_manual_rate = True
                    rec.move_id.currency_rate = rec.exchange_rate
                    rec.move_id.manual_rate()
            else:
                rec.force_amount_company_currency = rec.amount * rec.exchange_rate
                amount_company_currency = rec.force_amount_company_currency
